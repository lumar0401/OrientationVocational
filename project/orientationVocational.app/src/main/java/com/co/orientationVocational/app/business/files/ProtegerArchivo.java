...
public class ProtegerArchivo {
	private final static String clave = "kuaefbhqoeñkfew4efwbeiqw6qw5da";
	...
	public static void descifrarArchivo(String archivoCifrado, String archivoDescifrado) throws Exception {
        ...
        try (InputStream inputStream = new CipherInputStream(new FileInputStream(archivoCifrado), cipher);
